var productHandler={
    ...
    //SMC
    addLevantamientoSMC: function(id_cedula,foto_entrada,nombre_cliente,id_visita){
        databaseHandler.db.transaction(
            function(tx){
                tx.executeSql(
                    "insert into levantamiento_smc(id_cedula,foto_entrada,nombre_cliente,id_visita) values(?,?,?,?)",
                    [id_cedula,foto_entrada,nombre_cliente,id_visita],
                    function(tx, results){
    ...
    addMantenimientoSMC: function(id_cedula,foto_entrada,nombre_cliente,id_visita){
        databaseHandler.db.transaction(
            function(tx){
                tx.executeSql(
                    "insert into mantenimiento_smc(id_cedula,foto_entrada,nombre_cliente,id_visita) values(?,?,?,?)",
                    [id_cedula,foto_entrada,nombre_cliente,id_visita],
                    function(tx, results){
    ...
    addVICVentas: function (id_cedula, foto, id_proyecto) {
        databaseHandler.db.transaction(
          function (tx) {
            tx.executeSql(
              "insert into ventas_bennetts(id_cedula, foto_inicio, id_proyecto) values(?,?,?)",
              [id_cedula, foto, id_proyecto],
              function (tx, results) {
                // console.log("Registro de datos producto creado exitosamente");
              },
              function (tx, error) {
