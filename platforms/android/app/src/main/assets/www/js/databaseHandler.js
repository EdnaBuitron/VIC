        ...
        this.db.transaction(
            function(tx){
               ...
               if(empresa == "CarnesIdeal"){
                    ...
                    tx.executeSql(
                        "create table if not exists minuta(id_minuta integer primary key, id_cedula integer, tema text, compromiso text, fecha text, foto blob, fecha_foto text)",
                        [],
                        function(tx, results){
                ...
                tx.executeSql(
                 ...
                 tx.executeSql(
                    "create table if not exists proyectos_vic(id_proyecto integer primary key, id_usuario integer, nombre_proyecto text, potencial text, segmento text, division integer, fecha_creacion text, estatus integer, enviado integer,estrategia text,metodo text,grupo text)",
                    [],
                    function(tx, results){
            ...
            if(empresa == "ServInd"){
                ...
                tx.executeSql(
                    "create table if not exists checklist_servind(id_pregunta integer primary key,id_cedula integer,fase text,pregunta text,tipo text,valor text)",
                    [],
                    function(tx, results){
                      //console.log("Se creo datos_generales correcto");
                    },
                ...
                tx.executeSql(
                    "create table if not exists fotos_check(id_foto integer primary key, id_cedula integer, foto blob, pregunta text, fase text, observaciones text, fecha_foto text)",
                    [],
                    function(tx, results){
                      //console.log("Se creo datos_generales correcto");
                    },
                ...
                tx.executeSql(
                    "Create table if not exists papeleta(id_papeleta integer primary key,id_cedula integer,foto_papeleta blob, numero_parte text,descripcion text,prioridad text,cantidad text,fecha_registro text)",
                    [],
                    function(tx,results){
                ...
                tx.executeSql(
                    "Create table if not exists refacciones(id_refaccion integer primary key,id_cedula integer,foto_refa blob, numero_parte text,descripcion text,parte text,fecha_registro text)",
                    [],
                    function(tx,results){
                        // console.log("Se creo equipos reporte general Serv correctamente!")
                    },
